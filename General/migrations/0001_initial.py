    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postalcode', models.CharField(max_length=5, verbose_name='Codi postal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text="L'adre\xe7a d'email principal de l'entitat humana", max_length=100, verbose_name='Email')),
                ('telephone_cell', models.CharField(help_text="El tel\xe8fon principal de l'entitat Humana", max_length=20, null=True, verbose_name='Tel\xe8fon m\xf2bil', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('human', models.OneToOneField(parent_link=True, primary_key=True, serialize=False, to='General.Human')),
                ('surnames', models.CharField(help_text='Els cognoms de la Persona', max_length=200, verbose_name='Cognoms')),
                ('id_card', models.CharField(max_length=9, verbose_name='DNI/NIE')),
        ...
        migrations.AddField(
            model_name='address',
            name='region',
            field=mptt.fields.TreeForeignKey(related_name=b'rel_addresses', verbose_name='Comarca', to='General.Region'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='address',
