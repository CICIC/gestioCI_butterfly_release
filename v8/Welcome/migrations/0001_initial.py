    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_date', models.DateField(null=True, verbose_name="Data d'Alta", blank=True)),
                ('end_date', models.DateField(null=True, verbose_name='Data de Baixa', blank=True)),
                ('ic_company', models.ForeignKey(related_name=b'Entitats_legals', verbose_name='Cooperativa (Interprofessionals / XIPU)', blank=True, to='General.Company', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organic', models.BooleanField(default=False, verbose_name='Productes ecol\xf2gics')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tent_type', models.CharField(blank=True, max_length=5, null=True, verbose_name='Tipus parada firaire', choices=[(b'none', 'Sense Carpa'), (b'wood', 'Carpa de fusta'), (b'metal', 'Carpa met\xe0lica')])),
            ],
            options={
        ...
        migrations.AddField(
            model_name='ic_membership',
            name='ic_company',
            field=models.ForeignKey(related_name=b'memberships', verbose_name='Cooperativa (Interprofessionals / XIPU)', blank=True, to='General.Company', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='ic_membership',
        ...
        migrations.AddField(
            ...
            name='ic_membership',
            field=models.ManyToManyField(related_name=b'akin_memberships', null=True, verbose_name='vinculada als Projectes Socis', to='Welcome.iC_Membership', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='ic_akin_membership',
