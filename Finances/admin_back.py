...
class sales_invoice_admin(sales_invoice_user):
	...
	list_display_links = ( 'number', )
	list_editable = ('icf_self_employed',) + sales_invoice_user.list_editable + ('transfer_date', )
...
class purchases_invoice_admin (purchases_invoice_user):
	fields = ['icf_self_employed'] + purchases_invoice_user.fields + ['status', 'transfer_date']
	list_display = ('icf_self_employed',) + purchases_invoice_user.list_display
	list_editable = ('icf_self_employed',) + purchases_invoice_user.list_editable + ('transfer_date',)
	list_export = ('icf_self_employed',) + purchases_invoice_user.list_export
	list_filter = ('icf_self_employed','period',)
