...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Welcome', '0002_auto_20141110_1116'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='client',
            fields=[
                ('company_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='Finances.company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pointed_date', models.DateField(default=datetime.datetime(2014, 11, 13, 18, 22, 7, 695044), help_text="Per l'opci\xf3 -El dia senyalat-", verbose_name='Senyalar dia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(verbose_name='Trimestre', to='Finances.period')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(verbose_name='Client', to='Finances.client')),
                ('cooper', models.ForeignKey(verbose_name='n\xba COOP', to='Finances.cooper')),
                ('period', models.ForeignKey(verbose_name='Trimestre', to='Finances.period')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='sales_line',
            name='sales_invoice',
            field=models.ForeignKey(to='Finances.sales_invoice'),
            preserve_default=True,
        ),
        ...
        migrations.AddField(
            model_name='purchases_line',
            name='purchases_invoice',
            field=models.ForeignKey(to='Finances.purchases_invoice'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='period_close',
