...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='iCf_Purchase_li',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('value', models.DecimalField(verbose_name='Base imposable', max_digits=10, decimal_places=2)),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'sys_artwork_record',
                'verbose_name_plural': 'sys_artworks_record',
            },
            bases=(models.Model,),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales_base', models.DecimalField(null=True, verbose_name='Base Imposable Emeses (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('sales_invoiced_vat', models.DecimalField(null=True, verbose_name='IVA Facturat (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('sales_assigned_vat', models.DecimalField(null=True, verbose_name='IVA Assignat (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('sales_total', models.DecimalField(null=True, verbose_name='Total Emeses (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('purchases_base', models.DecimalField(null=True, verbose_name='Base Imposable Despeses (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('purchases_vat', models.DecimalField(null=True, verbose_name='IVA Despeses (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('purchases_irpf', models.DecimalField(null=True, verbose_name='Retenci\xf3 IRPF (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
                ('purchases_total', models.DecimalField(null=True, verbose_name='Total Despeses (\u20ac)', max_digits=10, decimal_places=2, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('who_manage', models.IntegerField(default=0, help_text="Si selecciona la opci\xf3 'desde la icf_self_employedativa' haur\xe0 d'ampliar informaci\xf3.", verbose_name='Forma de pagament', choices=[(0, 'Gestionat per la socia'), (1, 'Gestionat per la cooperativa')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('value', models.DecimalField(verbose_name='Base imposable', max_digits=10, decimal_places=2)),
                ('icf_sale', models.ForeignKey(to='Finances.iCf_Sale')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='iCf_Period',
            fields=[
                ('icf_record_type', models.OneToOneField(parent_link=True, primary_key=True, serialize=False, to='Finances.iCf_Record_Type')),
            ...
            options={
                'verbose_name': 'C - Trimestres',
                'verbose_name_plural': 'C - Trimestres',
            },
            bases=('Finances.icf_record_type',),
        ),
        migrations.CreateModel(
            name='period_payment',
            fields=[
        ...
        migrations.AddField(
            model_name='icf_sale_li',
            name='icf_sale_line',
            field=models.ForeignKey(related_name=b'fk_sale_li', verbose_name='Linia de factura', to='Finances.iCf_Sale_line'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_sale_li',
            name='percent_invoiced_vat',
            field=models.ForeignKey(verbose_name='IVA Facturat (%)', to='Finances.iCf_Duty', help_text="El % d'IVA que s'aplica en la factura. Indicar un valor d'IVA per concepte"),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_sale',
            name='lines',
            field=models.ManyToManyField(related_name=b'rn_Sale_line', to='Finances.iCf_Sale_line', through='Finances.iCf_Sale_li', blank=True, null=True, verbose_name='L\xednies'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='icf_purchase_li',
            name='icf_purchase',
            field=models.ForeignKey(to='Finances.iCf_Purchase'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_purchase_li',
            name='icf_purchase_line',
            field=models.ForeignKey(related_name=b'fk_purchase_li', verbose_name='Linia de factura', to='Finances.iCf_Purchase_line'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_purchase_li',
        ...
        migrations.AddField(
            model_name='icf_purchase',
            name='lines',
            field=models.ManyToManyField(related_name=b'rn_Purchase_line', to='Finances.iCf_Purchase_line', through='Finances.iCf_Purchase_li', blank=True, null=True, verbose_name='L\xednies'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_purchase',
            name='provider',
            field=models.ForeignKey(related_name=b'purchase_invoices_providers', verbose_name='Prove\xefdor', to='General.Company'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_period_close',
            name='icf_purchase_movements',
            field=models.ManyToManyField(related_name=b'icf_self_employed_purchase_movements', verbose_name='Factures Despeses', to='Finances.iCf_Purchase_movement'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_period_close',
            name='icf_purchases',
            field=models.ManyToManyField(related_name=b'rel_icfe_purchases', verbose_name='Factures Despeses', to='Finances.iCf_Purchase'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_period_close',
            name='icf_sale_movements',
            field=models.ManyToManyField(related_name=b'icf_self_employed_sale_movements', verbose_name='Factures Emeses', to='Finances.iCf_Sale_movement'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_period_close',
            name='icf_sales',
            field=models.ManyToManyField(related_name=b'rel_icfe_sales', verbose_name='Factures Emeses', to='Finances.iCf_Sale'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='icf_invoice',
            name='period',
            field=models.ForeignKey(verbose_name='Trimestre', blank=True, to='Finances.iCf_Period_close', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='icf_invoice',
