...
INSERT INTO `Welcome_ic_type` VALUES (1,'Registre CI','',NULL,1,20,1,0,'iC_Record'),(2,'Forma de Pagament','',NULL,1,2,2,0,''),(3,'alta Soci CI','',4,3,10,1,2,'iC_Membership'),(4,'Alta de Membre','',1,2,17,1,1,''),(5,'alta Projecte Autoocupat','',4,11,14,1,2,'iC_Self_Employed'),(6,'Document CI','',1,18,19,1,1,'iC_Document'),(7,'alta Soci Cooperatiu Individual','',3,4,5,1,3,''),(8,'alta Projecte Col·lectiu','',3,6,7,1,3,''),(9,'alta Projecte Públic','',3,8,9,1,3,''),(10,'alta Soci Afí Individual','',4,15,16,1,2,''),(11,'alta Projecte Firaire','',5,12,13,1,3,'iC_Stallholder');
...
CREATE TABLE `Welcome_ic_document_type` (
  ...
  CONSTRAINT `record_type_id_refs_artwork_type_id_bba54e5c` FOREIGN KEY (`record_type_id`) REFERENCES `General_record_type` (`artwork_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Welcome_ic_record_type` VALUES (3),(4),(5),(6);
...
-- Dump completed on 2014-08-07 15:21:09
CREATE DATABASE  IF NOT EXISTS `gestioCI_butterfly_release` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gestioCI_butterfly_release`;
-- MySQL dump 10.13  Distrib 5.5.35, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: gestioCI_butterfly_release
-- ------------------------------------------------------
-- Server version	5.5.35-0+wheezy1
