...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'sales_invoice.dateTransfer'
        db.add_column(u'Invoices_sales_invoice', 'dateTransfer',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'purchases_invoice.dateTransfer'
        db.add_column(u'Invoices_purchases_invoice', 'dateTransfer',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'sales_invoice.dateTransfer'
        db.delete_column(u'Invoices_sales_invoice', 'dateTransfer')

        # Deleting field 'purchases_invoice.dateTransfer'
        db.delete_column(u'Invoices_purchases_invoice', 'dateTransfer')
    ...
    models = {
        ...
        u'Invoices.provider': {
            ...
            'iban': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'otherCIF': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'Invoices.purchases_invoice': {
            ...
            'dateTransfer': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
