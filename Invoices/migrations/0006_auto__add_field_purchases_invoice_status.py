...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'purchases_invoice.status'
        db.add_column(u'Invoices_purchases_invoice', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'purchases_invoice.status'
        db.delete_column(u'Invoices_purchases_invoice', 'status')
