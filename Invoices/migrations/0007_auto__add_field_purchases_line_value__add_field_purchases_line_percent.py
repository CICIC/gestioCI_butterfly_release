...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'purchases_line.value'
        db.add_column(u'Invoices_purchases_line', 'value',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'purchases_line.percentExpencedVAT'
        db.add_column(u'Invoices_purchases_line', 'percentExpencedVAT',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Invoices.vats']),
                      keep_default=False)

        # Adding field 'purchases_line.percentIRPFRetention'
        db.add_column(u'Invoices_purchases_line', 'percentIRPFRetention',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'purchases_invoice.percentExpencedVAT'
        db.delete_column(u'Invoices_purchases_invoice', 'percentExpencedVAT_id')

        # Deleting field 'purchases_invoice.percentIRPFRetention'
        db.delete_column(u'Invoices_purchases_invoice', 'percentIRPFRetention')


    def backwards(self, orm):
        # Deleting field 'purchases_line.value'
        db.delete_column(u'Invoices_purchases_line', 'value')

        # Deleting field 'purchases_line.percentExpencedVAT'
        db.delete_column(u'Invoices_purchases_line', 'percentExpencedVAT_id')

        # Deleting field 'purchases_line.percentIRPFRetention'
        db.delete_column(u'Invoices_purchases_line', 'percentIRPFRetention')

        # Adding field 'purchases_invoice.percentExpencedVAT'
        db.add_column(u'Invoices_purchases_invoice', 'percentExpencedVAT',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Invoices.vats']),
                      keep_default=False)

        # Adding field 'purchases_invoice.percentIRPFRetention'
        db.add_column(u'Invoices_purchases_invoice', 'percentIRPFRetention',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
