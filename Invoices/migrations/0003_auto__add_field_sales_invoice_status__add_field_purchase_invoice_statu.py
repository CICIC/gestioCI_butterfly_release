...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'sales_invoice.status'
        db.add_column(u'Invoices_sales_invoice', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'purchase_invoice.status'
        db.add_column(u'Invoices_purchase_invoice', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'sales_invoice.status'
        db.delete_column(u'Invoices_sales_invoice', 'status')

        # Deleting field 'purchase_invoice.status'
        db.delete_column(u'Invoices_purchase_invoice', 'status')
