...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'purchases_invoice.num'
        db.add_column(u'Invoices_purchases_invoice', 'num',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'purchases_invoice.num'
        db.delete_column(u'Invoices_purchases_invoice', 'num')
